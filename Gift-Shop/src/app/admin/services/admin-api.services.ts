...
addOrderMessage(id: string, messageText: string): Observable<AdminOrderMessage> {
  ...
  // at the end of AdminApiService class

// ── Social Links ──────────────────────────────────────────────────────
getSocialLinks(): Observable<any[]> {
  return this.http.get<any[]>(`${API}/api/admin/social-links`, { headers: this.headers() }).pipe(catchError(err => throwError(() => err)));
}
createSocialLink(icon: string, name: string, url: string, sortOrder = 0): Observable<any> {
  return this.http.post(`${API}/api/admin/social-links`, { icon, name, url, sortOrder }, { headers: this.headers() });
}
updateSocialLink(id: string, data: any): Observable<any> {
  return this.http.put(`${API}/api/admin/social-links/${id}`, data, { headers: this.headers() });
}
deleteSocialLink(id: string): Observable<void> {
  return this.http.delete<void>(`${API}/api/admin/social-links/${id}`, { headers: this.headers() });
}
toggleSocialLink(id: string): Observable<any> {
  return this.http.put(`${API}/api/admin/social-links/${id}/toggle`, {}, { headers: this.headers() });
}

// ── Payment Details ──────────────────────────────────────────────────
getPaymentDetails(): Observable<any[]> {
  return this.http.get<any[]>(`${API}/api/admin/payment-details`, { headers: this.headers() }).pipe(catchError(err => throwError(() => err)));
}
createPaymentDetail(key: string, value: string, sortOrder = 0): Observable<any> {
  return this.http.post(`${API}/api/admin/payment-details`, { key, value, sortOrder }, { headers: this.headers() });
}
updatePaymentDetail(id: string, data: any): Observable<any> {
  return this.http.put(`${API}/api/admin/payment-details/${id}`, data, { headers: this.headers() });
}
deletePaymentDetail(id: string): Observable<void> {
  return this.http.delete<void>(`${API}/api/admin/payment-details/${id}`, { headers: this.headers() });
}
